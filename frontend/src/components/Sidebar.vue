<template>
	<div>
	  <button
		...
		type="button"
		class="inline-flex items-center p-2 mt-2 text-sm text-gray-500 rounded-lg ms-3 sm:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:focus:ring-gray-600"
	  >
	   ...
	   >
		 ...
		 >
		   <path
			 ...
			 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 
			 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25Z"
		   />
		 </svg>
			...
			<li>
			  ...
			  >
				...
				>
				  <path
					stroke-linecap="round"
					stroke-linejoin="round"
					d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 01-2.25 
					2.25M16.5 7.5V18a2.25 2.25 0 002.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 
					3 4.875V18a2.25 2.25 0 002.25 2.25h13.5M6 7.5h3v3H6v-3Z"
				  />
 
 
				</svg>
				<span class="flex-1 text-left ms-3 rtl:text-right whitespace-nowrap group-hover:text-black">
				  Registration <br> Management</span>
				<svg
			  ...
			  <ul id="dropdown-example" class="hidden py-2 space-y-2">
				<li>
				  ...
				  <span class="flex items-center ml-3 space-x-3 group-hover:text-black">
				   <svg class="flex-shrink-0 w-6 h-6 transition duration-75 text-cotton group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
				   ...
				   <span class="text-sm group-hover:text-black">Driver Management</span>
				   </span>
				...
				<li>
				  ...
				  <span class="flex items-center ml-3 space-x-3 group-hover:text-black">
				   ...
				   <span class="text-sm group-hover:text-black">Helper Management</span>
				   </span>
				  ...
				  <ul id="dropdown-helper" class="hidden py-2 space-y-2">
					   ...
					   <li><router-link to="/helperbooking" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
							<!-- Yung Router-LINK diyan ililink yung page para don (Not sure kung eto yung dapat na page) -->  
						 <span class="ml-6 text-sm group-hover:text-black">Booking</span>
						 </router-link>
					   </li>
					   <li><router-link to="/helperratings" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
						   <span class="ml-6 text-sm group-hover:text-black">Rating</span>
						 </router-link>
					   </li>
					   <li><router-link to="" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
					   ...
					   <li><router-link to="/helperlogs" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
						   <span class="ml-6 text-sm group-hover:text-black">Logs</span>
						</router-link>
					   </li>
					 </ul> 
				  ...
				  <span class="flex items-center ml-3 space-x-3 group-hover:text-black">
				   ...
				   <span class="text-sm group-hover:text-black">Client Management</span>
				   </span>
				  ...
				  <ul id="dropdown-client" class="hidden py-2 space-y-2">
					   <li> <router-link to="/ClientAccount" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
						   
						 <!-- Yung Router-LINK diyan ililink yung page para don -->
						 <span class="ml-6 text-sm group-hover:text-black">Account</span>
					   </router-link>
					   </li>
					   <li><router-link to="/ClientBooking" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg group hover:bg-gray-300 dark:text-white dark:hover:bg-gray-700">
							<!-- Yung Router-LINK diyan ililink yung page para don (Not sure kung eto yung dapat na page) -->  
						 <span class="ml-6 text-sm group-hover:text-black">Booking</span>
						 </router-link>
					   </li>
