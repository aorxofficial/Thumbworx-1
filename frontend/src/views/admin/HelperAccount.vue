...
<template>
    ...
    <div id="helperDetailsPop" class="collapse w-full absolute z-10 bg-black bg-opacity-50 pt-20 pb-20">
    <!-- pop up content div -->
     <div class="rounded-lg drop-shadow-lg border-1 border-slate-400 bg-white w-fit ml-auto mr-auto">
          ...
          <div class="px-8 text-white bg-blue-600 rounded-tl-lg rounded-tr-lg flex items-stretch"> 
            <legend class="self-center">Helper's Details</legend>
            <!-- close btn -->
...
methods: { //responsible for making the API request to fetch user data.
  ...
  closePopup(){
    document.getElementById("helperDetailsPop").classList.add('collapse');
  },
