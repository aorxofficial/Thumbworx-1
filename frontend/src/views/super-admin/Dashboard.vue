<template>
  <div class="px-10 py-10 relative justify-center w-full">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 p-4 gap-4 m-auto">

      <!-- card component -->
  <div class="h-28 bg-blue-500 dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4 border-blue-600 dark:border-gray-600 text-white font-medium group">
